...
typedef struct {
  ...
  unsigned int over_trip_point_absolute;          // If the value exceeds this it will trip immediatly ?units?
  unsigned int under_trip_point_absolute;         // If the value is less than this it will trip immediatly ?units?
