...
#define FAULT_BIT_COOLANT_TEMP_ANALOG            FAULT_BIT_USER_DEFINED_8
#define FAULT_BIT_LINAC_TEMP_ANALOG              FAULT_BIT_USER_DEFINED_9
#define FAULT_BIT_SF6_PRESSURE_SWITCH            FAULT_BIT_USER_DEFINED_10
#define FAULT_BIT_SF6_PRESSURE_ANALOG            FAULT_BIT_USER_DEFINED_11
